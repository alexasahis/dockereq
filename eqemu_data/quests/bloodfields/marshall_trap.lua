...
function event_enter(e)
	...
	if(qglobals["ranger_epic"] == "2" and qglobals["ranger_epic_bloodfield"] == nil and e.other:HasItem(62844) == true and eq.get_entity_list():IsMobSpawnedByNpcTypeID(301065) == false ) then
		...
		eq.spawn2(301065, 0, 0, 774,437,-924.8,197);
		eq.spawn2(301066, 0, 0, 740,436,-924.8,197);
		eq.spawn2(301067 ,0, 0, 729,457,-924.8,95);
		eq.spawn2(301068 ,0, 0, 762.7,457,-925.7,191);
		eq.spawn2(301068 ,0, 0, 762.7,435,-924.8,130);		
	end
end
